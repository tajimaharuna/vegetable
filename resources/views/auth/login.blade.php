            ...
            <div class="col-md-8">
                <div class="login-box card">
                    <div class="login-header card-header mx-auto">{{ __('messages.Login') }}</div>
                        <p class="login-copy">あなたの豆知識を教えてください！</p>
                    <div class="login-body card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <p>ログインしたらできること</p>
                            <ul>
                                <li class=login-about>記事を書く</li>
                                <li class=login-about>記事を修正する</li>
                                <li class=login-about>記事を削除する</li>
                            </ul>
                        </form>
                    </div>
                </div>
